...
class _AddServiceRecordPageState extends State<AddServiceRecordPage> {
    ...
    return BlocProvider(
      ...
      child: BlocListener<ServiceRecordsBloc, ServiceRecordsState>(
        listener: (context, state) {
          if (state is ServiceRecordsAddSuccess) {
  ...
  Widget _buildPhotoThumbnail(String path, {VoidCallback? onRemove}) {
    return Stack(
      children: [
        Container(
          width: 80.w,
