...
class AppStrings {
  ...
  static const String mileageKm = 'км';
  static const String fuelType = 'Тип топлива';
  static const String engineVolume = 'Объём двигателя';
  ...
  static const String serviceType = 'Тип работ';
  static const String serviceDate = 'Дата';
  static const String serviceMileage = 'Пробег при обслуживании';
  static const String serviceCost = 'Стоимость';
  static const String serviceStation = 'СТО';
  ...
  static const String reminderDate = 'Дата';
  ...
  static const String errorWeakPassword = 'Слабый пароль';
  static const String errorEmailInUse = 'Email уже используется';
  static const String errorUserNotFound = 'Пользователь не найден';
